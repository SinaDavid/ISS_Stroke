...
to do:
    ...
    - create validation procedure using decoder and actual 
    - create additional subgroup see whataps Sina.
      - in the loop by 288
    - create script to create dummy data for d3,d4,d5,d6...(NOT NECESARRY)
    - heatmap for d3 or more not possible (always need to fix the rest weird choice would that be)
    - with the models you can compare orginal signal vs reconstructed signal with similar bottle features
    - SNS PAIR PLOT TO SHOW DISCRIMINATIVE VALUE BETWEEN GROUPS.
    - SCATTERPLOT --> NOT SURE YET
...
savingModel = True
loadingInitializedWeights = True
