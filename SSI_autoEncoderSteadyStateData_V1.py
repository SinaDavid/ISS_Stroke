...
encoder = tensorflow.keras.layers.Conv1D(64, 5)(input_data)
encoder = tensorflow.keras.layers.LeakyReLU(alpha=0.1)(encoder)
# encoder = tensorflow.keras.layers.LeakyReLU(alpha=0.1)(encoder)
encoder = tensorflow.keras.layers.MaxPooling1D(2)(encoder)
encoder = tensorflow.keras.layers.Conv1D(64, 3)(encoder)
encoder = tensorflow.keras.layers.LeakyReLU(alpha=0.1)(encoder)
# encoder = tensorflow.keras.layers.LeakyReLU(alpha=0.1)(encoder)
encoder = tensorflow.keras.layers.MaxPooling1D(2)(encoder)
encoder = tensorflow.keras.layers.Conv1D(32, 3)(encoder)
encoder = tensorflow.keras.layers.LeakyReLU(alpha=0.1)(encoder)
# encoder = tensorflow.keras.layers.LeakyReLU(alpha=0.1)(encoder)
encoder = tensorflow.keras.layers.MaxPooling1D(2)(encoder)
...
decoder = tensorflow.keras.layers.LeakyReLU(alpha=0.1)(decoder)
decoder = tensorflow.keras.layers.Reshape((1, 16))(decoder)
decoder = tensorflow.keras.layers.UpSampling1D(21)(decoder)

decoder = tensorflow.keras.layers.Conv1DTranspose(32, 3)(decoder)
decoder = tensorflow.keras.layers.LeakyReLU(alpha=0.1)(decoder)
