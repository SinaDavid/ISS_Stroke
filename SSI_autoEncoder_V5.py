...
encoder = tensorflow.keras.layers.Dense(16, activation='relu')(encoder)

encoder = tensorflow.keras.layers.Dense(8, activation='relu')(encoder)
...
decoder = tensorflow.keras.layers.Dense(8, activation='relu')(decoder_input)
# decoder = tensorflow.keras.layers.Reshape((1, 16))(decoder)
decoder = tensorflow.keras.layers.Dense(16, activation='relu')(decoder_input)
decoder = tensorflow.keras.layers.Reshape((1, 16))(decoder)
decoder = tensorflow.keras.layers.UpSampling1D(21)(decoder)

decoder = tensorflow.keras.layers.Conv1DTranspose(32, 3, activation='relu')(decoder)
decoder = tensorflow.keras.layers.UpSampling1D(2)(decoder)
...
decoder = tensorflow.keras.layers.Conv1DTranspose(64, 3)(decoder)
decoder = tensorflow.keras.layers.UpSampling1D(2)(decoder)
# decoder_output = tensorflow.keras.layers.LeakyReLU(alpha=0.1)(decoder_output)
decoder_output = tensorflow.keras.layers.Conv1DTranspose(6, 5)(decoder)
# decoder = tensorflow.keras.layers.UpSampling1D(2)(decoder)

# decoder_output = tensorflow.keras.layers.Reshape((200, 6))(decoder)
